...
public static class StringExtensions
{
    ...
    {
        ThrowHelper.IfIsNullOrEmpty(self);
    ...
    {
        ThrowHelper.IfIsNullOrEmpty(self);
        ThrowHelper.IfLessThanOrEqZero(length);
    ...
    {
        ThrowHelper.IfIsNullOrEmpty(self);
        ThrowHelper.IfLessThanZero(length);
    ...
    {
        ThrowHelper.IfIsNullOrEmpty(self);
        ThrowHelper.IfIsNull(items);
        ThrowHelper.IfEqZero(items.Length);
